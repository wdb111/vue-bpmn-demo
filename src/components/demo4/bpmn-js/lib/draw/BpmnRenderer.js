...
export default function BpmnRenderer(
  ...
  var handlers = this.handlers = {
    ...
    'bpmn:Task': function(parentGfx, element) {
      var attrs = {
        fill: getFillColor(element, "#EDDBFA"),
        stroke: getStrokeColor(element, "#B483E6")
      };
    ...
    'bpmn:UserTask': function(parentGfx, element) {
      ...
      /* user3 path */ drawPath(parentGfx, pathData3, {
        strokeWidth: 0.5,
        fill: getStrokeColor(element, "#B483E6"),
        stroke: getStrokeColor(element, "#B483E6")
      });
    ...
    'bpmn:Gateway': function(parentGfx, element) {
      var attrs = {
        fill: getFillColor(element, "#FFF0DB"),
        fillOpacity: DEFAULT_FILL_OPACITY,
        stroke: getStrokeColor(element, "#FAD37E")
      };
    ...
    'bpmn:SequenceFlow': function(parentGfx, element) {
      ...
      var attrs = {
        ...
        markerEnd: marker('sequenceflow-end', "#8E909B", "#8E909B"),
        stroke: getStrokeColor(element, "#8E909B")
      };
